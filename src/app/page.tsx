    ...
    <div className="bg-[var(--page-bg)] text-[var(--ink)]">
      ...
      <main>
        ...
        <section id="about" className="mx-auto grid w-full max-w-6xl gap-8 px-5 py-14 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <p className="mt-5 leading-7 text-slate-600">
              Imo Robotics Center is a specialist medical institution focused on technology-enhanced prostate and urological
        ...
        <section className="mx-auto w-full max-w-6xl px-5 py-14 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-center text-slate-600">Real experiences from people who trusted Imo Robotics Center.</p>
