...
function fallbackContent(title: string, excerpt: string, category: string) {
  return `
    ...
    <p>At IMO Robotics Center, specialists combine diagnostics, evidence-based protocols, and precision-guided intervention strategies to improve safety and recovery.</p>
