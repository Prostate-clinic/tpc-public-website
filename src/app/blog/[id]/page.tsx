...
function fallbackContent(title: string, excerpt: string, category: string) {
  return `
    ...
    <p>At Imo Robotics and Oncology Center, specialists combine diagnostics, evidence-based protocols, and precision-guided intervention strategies to improve safety and recovery.</p>
